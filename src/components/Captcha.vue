<template>
  <div class="">
    ...
    <label
      ...
      for="captcha"
      class="px-4 py-3 group mt-2 border-2 relative inline-flex select-none cursor-pointer transition-all hover:border-blue-600 bg-gray-50 hover:bg-gray-100 rounded items-center"
    >
      <!-- hidden checkbox -->
      <input
        id="captcha"
